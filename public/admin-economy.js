...
function renderChipAdmin(rules,d,users){
  ...
  return `<div class="page-card chip-economy-overview"><h3>筹码经济 · 总设置</h3><p class="muted">签到和低保恢复属于系统增发；每局费用属于系统销毁；真人胜负筹码主要在玩家之间转移。v0.2.9 起，<b>入座不扣费</b>，只有一局真正开始时才扣一次；AI 练习费用低于真人局。</p><div class="chip-rule-grid chip-global-grid">${econInput('econFloor','默认 / 低保筹码',econVal(d.chipFloor,2000),0,'推荐 2000')}${econInput('econDaily','每日签到奖励',econVal(d.dailyReward,1000),0,'推荐 1000')}${econInput('econRecover','每小时恢复筹码',econVal(d.recoverPerHour,1000),0,'推荐 1000')}</div><p><button id="chipRulesSave" class="primary">保存全部经济设置</button></p></div>
  <div class="page-card"><h3>分游戏设置</h3><p class="muted">推荐值按一局常见时长、游戏本身是否已有下注 / 盲注 / 点数结算来分层。这里只是默认平衡值，管理员可独立调整每个游戏。</p><div class="chip-game-settings">
