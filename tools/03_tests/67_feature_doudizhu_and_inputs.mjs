...
ok(app.includes("'doudizhu'")&&app.includes("doudizhu:'三人斗地主"),'doudizhu missing from multiplayer game discovery'); // exact v0.4.6 placement is covered by 70_feature_market_admin_rankings.mjs
...
ok(html.includes('styles.css?v=0.4.6&build=046'),'v0.3.8 responsive stylesheet not loaded');
...
ok(up.version===11&&up.account.levelXpBase===777&&up.pet.feedXp===91,'v3 growth customization overwritten by v4 migration');
