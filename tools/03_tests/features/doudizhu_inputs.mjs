...
ok(app.includes("'doudizhu'")&&app.includes("doudizhu:'三人斗地主"),'doudizhu missing from multiplayer game discovery'); // exact v0.4.7 placement is covered by 70_feature_market_admin_rankings.mjs
...
ok(html.includes('styles.css?v=0.4.7&build=047'),'v0.3.8 responsive stylesheet not loaded');
