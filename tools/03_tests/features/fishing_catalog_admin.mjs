...
ok(css.includes('.admin-tabs-v038{display:flex')&&css.includes('#adminView .admin-tabs-v038{position:sticky!important'),'admin top tabs / v0.4.7 sticky repair missing');
...
console.log('[OK] v0.4.7 fishing resilience / sorting+bulk sell / catalogue / admin tabs / project cleanup');
