...
ok(app.includes("'doudizhu'")&&app.includes("doudizhu:'三人斗地主"),'doudizhu missing from multiplayer game discovery'); // exact v0.4.6 placement is covered by 70_features_v040.mjs
...
ok(up.version===10&&up.account.levelXpBase===777&&up.pet.feedXp===91,'v3 growth customization overwritten by v4 migration');
