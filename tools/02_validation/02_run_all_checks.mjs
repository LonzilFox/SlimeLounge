...
const syntaxFiles=['local_server.js','server/action_receipts.js','server/chat_service.js','server/chat_state.js','server/release_rewards.js','server/device_identity.js','server/device_profile.js','server/economy.js','server/http_room_transport.js','server/http_security.js','server/music_service.js','server/network_sync.js','server/rankings.js','server/leaderboard_http.js','server/release_notes.js','server/room_change_hub.js','server/runtime_diagnostics.js','server/progression.js','server/leisure_service.js','server/single_game_service.js','server/input_validation.js','server/music_http_routes.js','server/open_browser.js','server/static_service.js','server/game_lifecycle.js','server/user_merge.js','server/voice_config.js','server/ws_session_auth.js','server/ws_transport.js','public/admin-economy.js','public/app-games.js','public/app.js','public/ui-enhancements.js','public/startup-ui.js','public/chat-ui.js','public/game-dice.js','public/game-poker.js','public/game-mahjong.js','public/game-doudizhu.js','public/progression-ui.js','public/leisure-ui.js','public/music-ui.js','public/origin-migrate.js','shared/dice.js','shared/extra_games.js','shared/games.js','shared/riichi.js','shared/doudizhu.js','tools/00_maintenance/clean_repo.mjs','tools/02_validation/01_validate_project.js'];
const testGroups=[
