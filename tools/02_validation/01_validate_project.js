...
const required=['package.json','wrangler.jsonc','local_server.js','server/chat_state.js','server/release_rewards.js','server/music_service.js','server/economy.js','server/rankings.js','server/http_security.js','server/runtime_diagnostics.js','server/network_sync.js','server/static_service.js','server/game_lifecycle.js','server/ws_transport.js','server/room_change_hub.js','server/action_receipts.js','server/ws_session_auth.js','server/http_room_transport.js','server/device_identity.js','server/device_profile.js','server/user_merge.js','server/release_notes.js','server/voice_config.js','server/progression.js','server/leisure_service.js','server/input_validation.js','server/music_http_routes.js','server/open_browser.js','public/index.html','public/styles.css','public/styles-games.css','public/styles-responsive.css','public/styles-v038.css','public/origin-migrate.html','public/origin-migrate.js','public/app.js','public/accessory-visual.js','public/music-ui.js','public/chat-ui.js','public/game-dice.js','public/game-poker.js','public/game-mahjong.js','public/game-doudizhu.js','public/progression-ui.js','public/leisure-ui.js','public/ui-v038.js','public/admin-economy.js','public/app-games.js','src/index.js','shared/games.js','shared/dice.js','shared/extra_games.js','shared/riichi.js','shared/doudizhu.js','tools/01_runtime/02_owner_recovery.sh'];
...
const pkg=JSON.parse(fs.readFileSync(path.join(root,'package.json'),'utf8'));if(pkg.version!=='0.4.1'){console.error('[FAIL] version',pkg.version);fail=1}else console.log('[OK] version 0.4.1');
const workerSrc=fs.readFileSync(path.join(root,'src/index.js'),'utf8');if(!workerSrc.includes("version:'0.4.1'")){console.error('[FAIL] worker health version');fail=1}else console.log('[OK] worker health version 0.4.1');
...
const appUi=fs.readFileSync(path.join(root,'public/app.js'),'utf8')+fs.readFileSync(path.join(root,'public/music-ui.js'),'utf8')+fs.readFileSync(path.join(root,'public/chat-ui.js'),'utf8')+fs.readFileSync(path.join(root,'public/game-dice.js'),'utf8')+fs.readFileSync(path.join(root,'public/game-poker.js'),'utf8')+fs.readFileSync(path.join(root,'public/game-mahjong.js'),'utf8')+fs.readFileSync(path.join(root,'public/game-doudizhu.js'),'utf8')+fs.readFileSync(path.join(root,'public/progression-ui.js'),'utf8')+fs.readFileSync(path.join(root,'public/leisure-ui.js'),'utf8')+fs.readFileSync(path.join(root,'public/admin-economy.js'),'utf8')+fs.readFileSync(path.join(root,'public/app-games.js'),'utf8'),cssFiles=['public/styles.css','public/styles-games.css','public/styles-responsive.css','public/styles-v038.css'],cssUi=cssFiles.map(f=>fs.readFileSync(path.join(root,f),'utf8')).join('\n');
