...
const pkg=JSON.parse(fs.readFileSync(path.join(root,'package.json'),'utf8'));if(pkg.version!=='0.4.5'){console.error('[FAIL] version',pkg.version);fail=1}else console.log('[OK] version',pkg.version);
